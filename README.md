...
İki tasarım yönü hedefleniyor:

- **Sürüm karşılama animasyonu** — yeni bir sürüm tanıtılırkenki özel açılış animasyonu tarzında (ör. 3.5.5 açılışındaki gibi).
- **Gelişmiş yükleme ekranı** — Minecraft'ın yükleme ekranını iyileştiren popüler mod estetiğinde; daha canlı, hareketli ve bilgilendirici bir yükleme deneyimi.
